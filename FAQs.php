...
<div class="faq-answer">
    ...
    <p>It’s important to note that coverage varies by plan and provider. Certain policies may have exclusions for pre-existing conditions, breed-specific issues, or cosmetic procedures. Always review your policy details carefully to ensure it meets your pet’s specific needs!</p>
</div>
...
<div class="faq-answer">
    ...
    <ol>
        ...
        <li><strong>Provide claim details:</strong> Fill out the required fields, including the reason for the claim, date of the incident, and any relevant medical information.</li>
    ...
    <p>Our claims team will review your submission and validate the documents provided. This process typically takes 5-7 business days, but we strive to process claims as quickly as possible. If additional information is needed, we’ll reach out to you via email or phone.</p>
    <p>After approval, you’ll be reimbursed based on your policy’s coverage terms. The reimbursement will be sent directly to your bank account or as a check, depending on your chosen payment method.</p>
    <h4>Need help?</h4>
    <p>If you have any questions or encounter issues while filing your claim, our support team is here to assist. Contact us via phone, email, or live chat for personalized guidance.</p>
</div>
...
<div class="faq-answer">
    <p>Yes, many pet insurance providers offer routine care coverage as part of their plans or as an optional add-on. Routine care focuses on preventive healthcare to keep your pet healthy throughout the year. Here’s what is typically included:</p>
    <ul>
        ...
        <li><strong>Flea, Tick, and Heartworm Prevention:</strong> Coverage for preventive treatments and medications to safeguard your pet against pests and parasites.</li>
...
<div class="faq-answer">
    ...
    <ol>
        <li><strong>Policy Suspension:</strong> If a payment is overdue, your policy may be temporarily suspended. During this period, claims may not be processed until the balance is settled.</li>
        <li><strong>Grace Period:</strong> Most policies include a grace period (typically 7–14 days) to allow you to make the payment without penalties. Check your policy terms for details about your grace period.</li>
        <li><strong>Reinstatement:</strong> Once the payment is made, your policy will be reinstated, and coverage will resume. If the payment is significantly delayed, you may need to contact our billing team to ensure smooth reinstatement.</li>
    </ol>
    <p>To avoid missing future payments, consider setting up automatic payments via your debit/credit card or bank account. If you’re facing financial challenges, don’t hesitate to reach out to our support team for assistance in finding a solution.</p>
</div>
    </section>
